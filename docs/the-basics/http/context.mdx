...
- #### [The context object](#id-the-context-object)
  - #### [The request object](#id-the-request-object)
  - #### [The response object](#id-the-response-object)
  - #### [The params object](#id-the-params-object)
  - #### [The queries object](#id-the-queries-object)
  - #### [The data object](#id-the-data-object)
- #### [The context object in middlewares](#id-the-context-object-in-middlewares)
  - #### [Handle middleware context](#id-handle-middleware-context)
  - #### [Intercept middleware context](#id-intercept-middleware-context)
  - #### [Terminate middleware context](#id-terminate-middleware-context)
...
```typescript
import { HandleContextContract, MiddlewareContract } from '@athenna/http'
...
export class PaginationMiddleware implements MiddlewareContract {
   ...
   * @return any
   */
  handle({ request, data, next }: HandleContextContract) {
