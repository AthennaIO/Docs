...
- [`Globals`](/docs/the-basics/helpers#globals) - Execute global helpers exposed by 
Athenna.
...
<Path father="resources" child="fake-api" />:
...
Content of <Path father="fake-api" child="users.json" /> file:
...
Parse an array to an [Athenna collection](/docs/digging-deeper/collections):
...
Parse a vanilla error to an [Athenna exception](/docs/the-basics/helpers#exception):
...
Same as [`query()`](/docs/the-basics/helpers#httpclientbuilderquery), 
...
Pipe a csv to array parser to a Node.js stream:

```typescript
import { File, Parser } from '@athenna/common'

const results = []

new File('users.csv').createReadStream()
...
console.log(Path.dirs.services) // src/services
console.log(Path.dirs.controllers) // src/http/controllers
console.log(Path.dirs.bin) // bin 
```
...
Path.mergeDirs({
  ...
  controllers: 'src/internal/http/controllers',
  bootstrap: 'bin',
})
```
...
```typescript
const tsPath = 'src/services/MyService.ts'
const jsPath = 'src/services/MyService.js'

process.env.IS_TS = 'true'
console.log(Path.parseExt(tsPath)) // src/services/MyService.ts
console.log(Path.parseExt(jsPath)) // src/services/MyService.ts

process.env.IS_TS = 'false'
console.log(Path.parseExt(tsPath)) // src/services/MyService.js
console.log(Path.parseExt(jsPath)) // src/services/MyService.js
```
...
console.log(Path.app()) // /home/user/athenna-project/src
```
...
console.log(Path.models()) // /home/user/athenna-project/src/models
```
...
console.log(Path.config()) // /home/user/athenna-project/src/config
```
...
console.log(Path.database()) // /home/user/athenna-project/src/database
```
...
console.log(Path.lang()) // /home/user/athenna-project/src/lang
```
...
console.log(Path.providers()) // /home/user/athenna-project/src/providers
```
...
console.log(Path.facades()) // /home/user/athenna-project/src/facades
```
...
console.log(Path.storage()) // /home/user/athenna-project/src/storage
```
...
console.log(Path.logs()) // /home/user/athenna-project/src/storage/logs
```
...
console.log(Path.http()) // /home/user/athenna-project/src/http
```
...
console.log(Path.console()) // /home/user/athenna-project/src/console
```
...
Merge the project root path with `Path.dirs.cron`:

```typescript
import { Path } from '@athenna/common'

console.log(Path.cron()) // /home/user/athenna-project/src/cron
```

#### `Path::setCron()`

Set the `Path.dirs.cron` value:

```typescript
import { Path } from '@athenna/common'

Path.setCron('cron/app')
```
...
console.log(Path.services()) // /home/user/athenna-project/src/services
```
...
console.log(Path.jobs()) // /home/user/athenna-project/src/jobs
```
...
console.log(Path.repositories()) // /home/user/athenna-project/src/repositories
```
...
console.log(Path.commands()) // /home/user/athenna-project/src/console/commands
```
...
Merge the project root path with `Path.dirs.schedulers`:

```typescript
import { Path } from '@athenna/common'

console.log(Path.schedulers()) // /home/user/athenna-project/src/cron/schedulers
```

#### `Path::setSchedulers()`

Set the `Path.dirs.schedulers` value:

```typescript
import { Path } from '@athenna/common'

Path.setSchedulers('schedulers/app')
```
...
console.log(Path.controllers()) // /home/user/athenna-project/src/http/controllers
```
...
console.log(Path.guards()) // /home/user/athenna-project/src/http/guards/
```
...
console.log(Path.exceptions()) // /home/user/athenna-project/src/exceptions
```
...
console.log(Path.middlewares()) // /home/user/athenna-project/src/http/middlewares
```
...
console.log(Path.interceptors()) // /home/user/athenna-project/src/http/interceptors
```
...
console.log(Path.terminators()) // /home/user/athenna-project/src/http/terminators
```
...
console.log(Path.migrations()) // /home/user/athenna-project/src/database/migrations
```
...
console.log(Path.seeders()) // /home/user/athenna-project/src/database/seeders
```
...
```typescript title="/home/user/athenna-project/src/logPath.ts"
import { Path } from '@athenna/common'
...
```typescript title="/home/user/athenna-project/bin/index.ts"
import { logPath } from '#src/logPath'

logPath() // /home/user/athenna-project/src
```
