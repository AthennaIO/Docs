...
to the `handle` method of `app/Console/Exceptions/Handler.js` class. By default,
Athenna forward the error to the `handle` method of `ConsoleExceptionHandler` from Artisan
using super.
