...
Here is a simple tutorial on how you can build your own facade inside Athenna.

First you need to create a new [`service provider`](/docs/architecture-concepts/providers) to resolve your dependency
inside the [`service container`](/docs/architecture-concepts/container). Just run `athenna make:provider HelperProvider`
...
Finally, with your provider registered you can just run `athenna make:facade String` command to generate your facade:
