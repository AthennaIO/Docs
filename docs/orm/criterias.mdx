...
:::tip
Always remember that basically any method (excluding the executors method like `create`) that are available in your
models query builder ([`ModelQueryBuilder`](/docs/orm/getting-started#id-building-queries)) can be used by your criterias.
:::
