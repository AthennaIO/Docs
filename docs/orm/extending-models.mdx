...
All the Athenna models extends the [`Model`](https://github.com/AthennaIO/Database/blob/develop/src/Models/Model.js) class of the `@athenna/database` package. This class
...
:::tip
Also, we recommend you to take a look at the implementation of the [`Model`](https://github.com/AthennaIO/Database/blob/develop/src/Models/Model.js) class, this way you
could have more knowledge about all the methods available for your in the `this` property when implementing your own methods.
:::
