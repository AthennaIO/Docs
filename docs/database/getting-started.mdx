...
running and reverting [migrations](/docs/database/migrations), [transactions](/docs/database/transactions), queries, connecting
to new databases and also closing these connections.**
