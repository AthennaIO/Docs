...
<nav aria-label="breadcrumbs">
    <ul class="breadcrumbs">
        ...
        <li class="breadcrumbs__item">
            <a class="breadcrumbs__link" href="/docs/digging-deeper/collections">Collections</a>
        </li>
    </ul>
</nav>
...
- #### [Creating collections](#id-creating-collections)
- #### [Extends collections](#id-extending-collections)
- #### [Available methods](#id-available-methods)
...
### Extending collections {#id-extending-collections}
...
:::tip
Typically, you should declare collection macros in the `boot` method of a [service provider](/docs/architecture-concepts/providers).
:::

#### Macro arguments {#id-macro-arguments}
...
#### `containsOneItem()` {#id-containsOneItem}
...
#### `doesntContain()` {#id-doesntContain}
...
#### `intersectByKeys()` {#id-intersectByKeys}
...
> This is only added to adhere to the Laravel collection API, when using Collect.js it's recommended to use `new Collection()` directly when creating a new collection.
...
#### `mapToDictionary()` {#id-mapToDictionary}
...
#### `mergeRecursive()` {#id-mergeRecursive}
...
#### `removeDuplicated()` {#id-removeDuplicated}
...
#### `replaceRecursive()` {#id-replaceRecursive}
...
#### `unlessEmpty()` {#id-unlessEmpty}

Alias for the [`whenNotEmpty()`](#id-whenNotEmpty) method

#### `unlessNotEmpty()` {#id-unlessNotEmpty}
...
#### `whereInstanceOf()` {#id-whereInstanceOf}
...
#### `whereNotBetween()` {#id-whereNotBetween}
