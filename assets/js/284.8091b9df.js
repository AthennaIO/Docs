...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-8af3addd.js + 8 modules
var mermaid_8af3addd = __webpack_require__(56363);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/createText-62fc7601.js
...
const createText = (el, text = "", {
  ...
  mermaid_8af3addd.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,mermaid_8af3addd.J)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
/* harmony import */ var _createText_62fc7601_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36947);
...
/* harmony import */ var _edges_f2ad444c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(27707);
...
/* harmony import */ var _createText_62fc7601_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(36947);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  extractor(graph, 0);
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
      ...
      _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(clusterGraph));
      _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
    } else {
      _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramtype, id, parentCluster) => {
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), parentCluster);
  ...
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
...
/* harmony import */ var _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(56363);
/* harmony import */ var _index_2c4b9a3b_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(90360);
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.D) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(itemId, (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeTextOrArray(newNode.description, (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.c)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.a ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.b:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.D:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(item.description, (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_9c745c82_js__WEBPACK_IMPORTED_MODULE_7__.c) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = async function(text, id, _version, diag) {
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  diag.db.getDirection();
  const { securityLevel, state: conf } = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.c)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.info(diag.db.getRootDocV2());
  ...
  await (0,_index_2c4b9a3b_js__WEBPACK_IMPORTED_MODULE_9__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
  const bounds = svg.node().getBBox();
  const width = bounds.width + padding * 2;
  const height = bounds.height + padding * 2;
  svg.attr("class", CSS_DIAGRAM);
  const svgBounds = svg.node().getBBox();
  (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.i)(svg, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_8__.l.debug(`viewBox ${vBox}`);
