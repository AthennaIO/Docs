...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/sankeyDiagram-8f13d901.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_8af3addd.e.sanitizeText(ID, (0,mermaid_8af3addd.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_8af3addd.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_8af3addd.c)();
  const defaultSankeyConfig = mermaid_8af3addd.I.sankey;
  let sandboxElement;
  ...
  (0,mermaid_8af3addd.i)(svg, height, width, useMaxWidth);
