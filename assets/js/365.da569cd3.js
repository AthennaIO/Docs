...
const DEFAULT_PIE_CONFIG = _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.A.pie;
...
const addSection = (label, value) => {
  label = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.d)(label, (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  if (sections[label] === void 0) {
    sections[label] = value;
    _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`added new section: ${label}, with value: ${value}`);
  }
};
...
const draw = (text, id, _version, diagObj) => {
  var _a, _b;
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("rendering pie chart\n" + text);
  const db2 = diagObj.db;
  const globalConfig = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const pieConfig = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.B)(db2.getConfig(), globalConfig.pie);
  const height = 450;
  const width = ((_b = (_a = document.getElementById(id)) == null ? void 0 : _a.parentElement) == null ? void 0 : _b.offsetWidth) ?? pieConfig.useWidth;
  const svg = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.z)(id);
  svg.attr("viewBox", `0 0 ${width} ${height}`);
  (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.i)(svg, height, width, pieConfig.useMaxWidth);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_4__.C)(themeVariables.pieOuterStrokeWidth);
