...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const clear = () => {
  ...
  latestElement = {};
  elements = {};
  (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.t)();
};
const db = {
  RequirementType,
  RiskLevel,
  VerifyType,
  Relationships,
  getConfig: () => (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.c)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
  ...
  setAccTitle: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.s,
  getAccTitle: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.g,
  setAccDescription: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.b,
  getAccDescription: _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.a,
  addElement,
  getElements,
  setNewElementType,
  setNewElementDocRef,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.c)().requirement;
  ...
  (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_6__.i)(svg, height, width, conf.useMaxWidth);
