...
let vertexCounter = 0;
let config = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.c)();
let vertices = {};
let edges = [];
let classes = {};
let subGraphs = [];
...
let version;
let funs = [];
const sanitizeText = (txt) => _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, config);
...
const addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const addSingleLink = function(_start, _end, type) {
  ...
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 Got edge...", edge);
  ...
  if (edges.length < 280) {
    _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 pushing edge...");
    edges.push(edge);
  } else {
...
const addLink = function(_start, _end, type) {
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.l.info("addLink (abc78)", _start, _end, type);
  let i, j;
...
const updateLink = function(positions, style) {
  positions.forEach(function(pos) {
    if (pos === "default") {
      ...
      if (_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.u.isSubstringInArray("fill", style) === -1) {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if ((0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel !== "loose") {
    return;
  }
...
const setLink = function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const addSubGraph = function(_id, list, _title) {
  ...
  _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
...
const flowDb = {
  defaultConfig: () => _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_1__.I.flowchart,
...
/* harmony export */ });
/* harmony import */ var _flowDb_1972c806_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(75254);
/* harmony import */ var _styles_080da4f6_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(38621);
/* harmony import */ var _mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(56363);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64218);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45625);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41644);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39354);
...
const diagram = {
  parser: _flowDb_1972c806_js__WEBPACK_IMPORTED_MODULE_7__.p,
  db: _flowDb_1972c806_js__WEBPACK_IMPORTED_MODULE_7__.f,
  renderer: _styles_080da4f6_js__WEBPACK_IMPORTED_MODULE_8__.f,
  styles: _styles_080da4f6_js__WEBPACK_IMPORTED_MODULE_8__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_mermaid_8af3addd_js__WEBPACK_IMPORTED_MODULE_9__.p)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
    _styles_080da4f6_js__WEBPACK_IMPORTED_MODULE_8__.f.setConf(cnf.flowchart);
    _flowDb_1972c806_js__WEBPACK_IMPORTED_MODULE_7__.f.clear();
    _flowDb_1972c806_js__WEBPACK_IMPORTED_MODULE_7__.f.setGen("gen-2");
  }
};
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-8af3addd.js + 8 modules
var mermaid_8af3addd = __webpack_require__(56363);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/index-2c4b9a3b.js
var index_2c4b9a3b = __webpack_require__(90360);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/styles-080da4f6.js
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,mermaid_8af3addd.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    mermaid_8af3addd.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      mermaid_8af3addd.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,mermaid_8af3addd.m)((0,mermaid_8af3addd.c)().flowchart.htmlLabels)) {
        const node = {
        ...
        const rows = vertexText.split(mermaid_8af3addd.e.lineBreakRegex);
        for (const row of rows) {
    ...
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,mermaid_8af3addd.c)().flowchart.padding
    });
    mermaid_8af3addd.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText: vertexText,
...
const addEdges = function(edges, g, diagObj) {
  mermaid_8af3addd.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,mermaid_8af3addd.k)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      mermaid_8af3addd.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      mermaid_8af3addd.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    mermaid_8af3addd.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    ...
    if (edge.style !== void 0) {
      const styles = (0,mermaid_8af3addd.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_8af3addd.n)(edge.interpolate, src/* curveLinear */.c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_8af3addd.n)(edges.defaultInterpolate, src/* curveLinear */.c_6);
    } else {
      edgeData.curve = (0,mermaid_8af3addd.n)(conf.curve, src/* curveLinear */.c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
    ...
    edgeData.label = edge.text.replace(mermaid_8af3addd.e.lineBreakRegex, "\n");
    if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  mermaid_8af3addd.l.info("Drawing flowchart");
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,mermaid_8af3addd.c)();
  ...
  mermaid_8af3addd.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    mermaid_8af3addd.l.info("Subgraph - ", subG);
  ...
  mermaid_8af3addd.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,src/* selectAll */.td_)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      mermaid_8af3addd.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  await (0,index_2c4b9a3b.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  mermaid_8af3addd.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,mermaid_8af3addd.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
